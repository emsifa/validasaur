...
Deno.test(
  "validateValue() on empty value with non-required rules should be passes",
  async () => {
...
Deno.test(
  "validateValue() on null value with nullable rules should be passes",
  async () => {
    const errs = await validateValue(
      null,
...
Deno.test(
  "validateValue() on empty value with required rules should be error",
  async () => {
    const errs = await validateValue(
      null,
...
Deno.test(
  "validateValue() on implicit rule should returns only 1 error message",
  async () => {
    const errs = await validateValue(
      null,
...
Deno.test(
  "validateValue() on non-implicit rule should returns all error message",
  async () => {
    const errs = await validateValue(
      "text",
      [isString, isNumber, isInt],
...
Deno.test(
  "validateData() advanced example should return as expected",
  async () => {
...
Deno.test(
  "validate() with conditionally required fields should return expected results",
  async () => {
    const rules = {
