...
Deno.test("notIn([0, 1, 2])(0) should be invalid", () => {
  assertInvalid(notIn([0, 1, 2])(0) as RuleReturn, invalid("notIn", { value: 0, disallowedValues: [0, 1, 2] }));
});

Deno.test("notIn([0, 1, 2])(2) should be invalid", () => {
  assertInvalid(notIn([0, 1, 2])(2) as RuleReturn, invalid("notIn", { value: 2, disallowedValues: [0, 1, 2] }));
});
