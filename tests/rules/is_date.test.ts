...
Deno.test("rules.isDate(null) should be invalid", () => {
  assertInvalid(isDate(null), invalid("isDate", { value: null }));
});

Deno.test("rules.isDate(undefined) should be invalid", () => {
  assertInvalid(isDate(undefined), invalid("isDate", { value: undefined }));
});

Deno.test("rules.isDate('') should be invalid", () => {
  assertInvalid(isDate(""), invalid("isDate", { value: "" }));
});

Deno.test("rules.isDate(2020) should be invalid", () => {
  assertInvalid(isDate(2020), invalid("isDate", { value: 2020 }));
});

Deno.test("rules.isDate('2020-01') should be invalid", () => {
  assertInvalid(isDate("2020-01"), invalid("isDate", { value: "2020-01" }));
});
