...
Deno.test("rules.requiredUnless('confirmed', '1')(null, { confirmed: '0' }) should be invalid", () => {
...
Deno.test("rules.requiredUnless('confirmed', '1')(null, { confirmed: '1' }) should be valid", () => {
  const utils = makeValidationUtils({
    confirmed: "1",
  });
...
Deno.test("rules.requiredUnless('confirmed', '1')(10, { confirmed: '0' }) should be valid", () => {
  const utils = makeValidationUtils({
    confirmed: "0",
  });
